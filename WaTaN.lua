...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇Source Shayeb.")  
...
send(chat,msg.id_," ←︙هذا الملف غير تابع لسورس الشايب")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './WaTaN.lua', '←︙نسخة ملف سورس الشايب')
end 
end
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'←︙اصدار سورس الشايب \n←︙الاصدار »{ v 3.0 }')
end
...
*تحديثات وشروحات سورس الشايب*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇Shayeb 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/ADIL721"}},
}
...
send(msg.chat_id_,0," ←︙العضو : {["..data.first_name_.."](t.me/ADIL721)}\n←︙["..WaTaN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ←︙عذرا » {["..data.first_name_.."](t.me/ADIL721)}\n←︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = "[⦑ Welcome to Source ⦒](t.me/ADIL721)\n[← ⦑ SOURCE Shayeb ⦒](t.me/ADIL721)\n← Source version : 3.0"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'قناه المطور👨‍💻',url="t.me/ADIL721"},
{text = 'قناه السورس 🌿',url="t.me/Shayeb3"}},
{{text = 'تنزيل السورس 🖇️',url="https://t.me/ADIL721/7"},
{text = 'كروب المطور 📨',url="https://t.me/Al3mre1"}},
{{text = 'المطور 🎤',url="t.me/Sayeb_1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ADIL721&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './File_Bot/Reply.lua', '←︙ملف الردود الخاص بسورس الشايب')
end 
end
...
if Get_info then
local TextS = "\n←︙اهلا بك في متجر ملفات الشايب\n←︙ملفات السورس ↓\nٴ≪━━━━ Shayeb ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ Shayeb ━━━━≫ٴ\n←︙علامة تعني { ✔️ } ملف مفعل\n←︙علامة تعني { ✖ } ملف معطل\n←︙قناة سورس الشايب ↓\n".." ←︙[اضغط هنا لدخول](t.me/ADIL721) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ←︙عذرا الملف لايدعم سورس الشايب \n") 
end
return false
end
...
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/ADIL721"}},
}
local msg_id = msg.id_/2097152/0.5
...
Text = [[
  ←︙[DeVeLoPErE OF SoURcE](https://t.me/Sayeb_1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '←︙DeVeLoPErE OF SoURcE',url="t.me/Sayeb_1"}},
{{text = '←︙ChAnNeL OF SoURcE',url="t.me/ADIL721"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ADIL721&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[←︙ChAnNeL OF SoURcE](https://t.me/ADIL721)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '←︙ChAnNeL OF SoURcE',url="t.me/ADIL721"}},
...
{{text = 'WaTaN TeaM .', url="t.me/ADIL721"}},
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الشايب').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الشايب')
local WaTaN_Msg = {
'عمغي 🥺💕.',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇Source Shayeb.',url="t.me/ADIL721"}},
}
local msg_id = msg.id_/2097152/0.5
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ""..(database:get(bot_id..'Name:Bot') or 'الشايب').." غادر" or text == 'غادر' then  
...
if text == "تنظيف الكروبات" and ChanSub(msg) and DevWaTaN(msg) then 
local group = database:smembers(bot_id..'Chek:Groups') 
local w = 0
local q = 0
for i = 1, #group do
...
{
{text = 'Follow Shayb 📨', url="t.me/ADIL721"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الشايب')
